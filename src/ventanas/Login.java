...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 230, -1));
        ...
        getContentPane().add(jLabel_Footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 480, -1, -1));

        jLabel_Wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Fondo.png"))); // NOI18N
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 520));
        ...
        if (!user.equals("") || !pass.equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    } else if (tipo_nivel.equalsIgnoreCase("Pasante") && estatus.equalsIgnoreCase("Activo")) {
                        dispose();
