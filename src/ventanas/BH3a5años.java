 ...
 * @author raula
 */
public class BH3a5años extends javax.swing.JFrame {
    ...
    public BH3a5años() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BH3a5años where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BH3a5años set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
         ...
         try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BH3a5años set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        elevado6_1.setSpacingAfter(0);
          ...
          if(EritrocitosRe>=4.1 && EritrocitosRe<=4.8){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>4.1 && EritrocitosRe<=4.8){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>4.8 && EritrocitosRe<10){
        ...
        Paragraph Num411 = new  Paragraph ("4.8" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num412 = new  Paragraph ("4.8" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num413 = new  Paragraph ("4.8" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HemoglobinaRe>=11 && HemoglobinaRe<=14){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>10 && HemoglobinaRe<11){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>11 && HemoglobinaRe<14){
        ...
        Paragraph Num5111 = new  Paragraph ("11" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num5112 = new  Paragraph ("11" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num5113 = new  Paragraph ("11" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>33 && HematocritoRe<40){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>40 && HematocritoRe<100){
        ...
        Paragraph Num41111 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41112 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num41113 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Leucocitostotales1.setSpacingAfter(-3);
          ...
          if(LeucocitostotalesTT>=6000 && LeucocitostotalesTT<=12000){
        ...
        Paragraph LeucocitostotalesV2 = new  Paragraph ("12000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV21 = new  Paragraph ("12000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV212 = new  Paragraph ("12000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2123 = new  Paragraph ("12000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        NeutrófilosS1 .setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1500 && Neutrófilossegmentados1TT<=7000){
        ...
        NeutrófilosS2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1500){
        ...
        NeutrófilosSR1.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1500 && Neutrófilossegmentados1TT<=7000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1500 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1500 && Neutrófilossegmentados1TT<=7000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR2P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1500 && Neutrófilossegmentados1TP>=10){
        ...
        Paragraph NeutrófilosSVref = new  Paragraph ("1500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref1 = new  Paragraph ("1500" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref2 = new  Paragraph ("1500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref3 = new  Paragraph ("1500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=8000){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=8000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>8000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=8000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>8000 && Linfocitos1TP>=10){
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("8000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("8000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("8000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("8000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BH3a5años.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
