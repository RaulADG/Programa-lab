 ...
 * @author raula
 */
public class Anticoagulantelúpico extends javax.swing.JFrame {
    ...
    public Anticoagulantelúpico() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from Anticoagulantelúpico where ID_estudio = '" + IEstudio + "'");
          ResultSet rs2 = pst2.executeQuery();
          
          if (rs2.next()) {
            
            txt_hora.setText(rs2.getString("Hora"));
            jDateChooser_fEntrega.setDate(rs2.getDate("Fecha_entrega"));
            jTextPane_indicaciones.setText(rs2.getString("Observaciones"));
            txt_Reporte.setText(rs2.getString("Reporte_generado"));
            txt_Anticoagulantelúpico.setText(rs2.getString("Anticoagulantelúpico"));
...
@Override
    ...
    private void initComponents() {
        ...
        txt_Anticoagulantelúpico = new javax.swing.JTextField();
        ...
        getContentPane().add(jDateChooser_fEntrega, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 270, 250, 26));
        ...
        getContentPane().add(txt_Reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 695, 210, -1));
        ...
        getContentPane().add(jLabel_Datos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 700, -1, -1));
        ...
        jLabel_Logaritmo.setText("Anticoagulante lúpico:");
        getContentPane().add(jLabel_Logaritmo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 635, -1, -1));

        txt_Anticoagulantelúpico.setBackground(new java.awt.Color(153, 153, 255));
        txt_Anticoagulantelúpico.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_Anticoagulantelúpico.setForeground(new java.awt.Color(255, 255, 255));
        txt_Anticoagulantelúpico.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_Anticoagulantelúpico.setBorder(new javax.swing.border.SoftBevelBorder(0));
        getContentPane().add(txt_Anticoagulantelúpico, new org.netbeans.lib.awtextra.AbsoluteConstraints(165, 630, 210, -1));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 820));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, observaciones, Anticoagulantelúpico,Reporte_generado1; 
      ...
      fechaEntrega = dFormat.format(jDateChooser_fEntrega.getDate());
      hora = hourtwenty0.format(d0)+ " "+ ampm;
      observaciones = jTextPane_indicaciones.getText().trim();
      Anticoagulantelúpico = txt_Anticoagulantelúpico.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(Anticoagulantelúpico.equals("")) {
           txt_Anticoagulantelúpico.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into Anticoagulantelúpico values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
             ...
             pst.setString(13, Anticoagulantelúpico);
             ...
             txt_Anticoagulantelúpico.setBackground(Color.green);
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, Anticoagulantelúpico,Reporte_generado1; 
      Calendar calendario = new GregorianCalendar();
      ampm = calendario.get(Calendar.AM_PM)==Calendar.AM?"a.m.":"p.m.";
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update Anticoagulantelúpico set Fecha_entrega=?, Hora=?, Observaciones=?, Anticoagulantelúpico=?,ultima_modificacion=? " 
             ...
             pst.setString(4, Anticoagulantelúpico);
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
        ...
        try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update Anticoagulantelúpico set Hora=?, ultima_modificacion=?"
     ...
     com.itextpdf.text.Image logo = com.itextpdf.text.Image.getInstance("images/LogoT.jpg");
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        Paragraph fecha1 = new  Paragraph (dFormat.format(jDateChooser_fEntrega.getDate())+ " de " + dFormat1.format(jDateChooser_fEntrega.getDate()) + " de " + dFormat2.format(jDateChooser_fEntrega.getDate())+ "\n"  , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        resultado.setIndentationLeft(260);
        ...
        Chunk chunk2 = new Chunk("Anticoagulante lúpico", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: Coagulación cronometrada" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        metodo.setSpacingBefore(2);
        metodo.setIndentationLeft(17);
        metodo.setSpacingAfter(-3);
        documento.add(metodo);

        Paragraph AnticoagulanteL = new  Paragraph (txt_Anticoagulantelúpico.getText(), FontFactory.getFont("arial", 11, Font.BOLD, BaseColor.BLACK));
        AnticoagulanteL.setSpacingBefore(-27);
        AnticoagulanteL.setIndentationLeft(265);
        AnticoagulanteL.setSpacingAfter(-3);

        Paragraph AnticoagulanteLR = new  Paragraph (txt_Anticoagulantelúpico.getText(), FontFactory.getFont("arial", 11, Font.BOLD, BaseColor.BLACK));
        AnticoagulanteLR.setSpacingBefore(-27);
        AnticoagulanteLR.setIndentationLeft(265);
        AnticoagulanteLR.setSpacingAfter(-3);

        Paragraph AnticoagulanteL1 = new  Paragraph (txt_Anticoagulantelúpico.getText(), FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        AnticoagulanteL1.setSpacingBefore(-27);
        AnticoagulanteL1.setIndentationLeft(265);
        AnticoagulanteL1.setSpacingAfter(-3);
        
        if(txt_Anticoagulantelúpico.getText().contains("Positivo")){
         documento.add(AnticoagulanteLR);
        } else {
        if(txt_Anticoagulantelúpico.getText().contains("Negativo")){
          documento.add(AnticoagulanteL1);
        } else {
          documento.add(AnticoagulanteL1);
        }
          }
        
        Paragraph copiasM = new  Paragraph ("Negativo" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        copiasM.setSpacingBefore((float) -13.5);
        copiasM.setIndentationLeft(450);
        copiasM.setSpacingAfter(-3);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anticoagulantelúpico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Anticoagulantelúpico().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txt_Anticoagulantelúpico;
