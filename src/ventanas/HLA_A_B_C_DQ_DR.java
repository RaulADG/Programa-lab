 ...
 * @author raula
 */
public class HLA_A_B_C_DQ_DR extends javax.swing.JFrame {
...
Calendar calendario;
    ...
    public HLA_A_B_C_DQ_DR() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from HLA_A_B_C_DQ_DR where ID_estudio = '" + IEstudio + "'");
          ...
          if (rs2.next()) {
            ...
            txt_ESPÉCIMEN.setText(rs2.getString("ESPÉCIMEN"));
            txt_ESTUDIOHISTOPATOLÓGICO.setText(rs2.getString("ESTUDIO_HISTOPATOLÓGICO"));
            txt_p16.setText(rs2.getString("p16"));
            txt_Ki67.setText(rs2.getString("Ki67"));
          }
    ...
    private void initComponents() {
        ...
        jLabel_ESPÉCIMEN = new javax.swing.JLabel();
        txt_ESPÉCIMEN = new javax.swing.JTextField();
        jLabel_ESTUDIO = new javax.swing.JLabel();
        txt_ESTUDIOHISTOPATOLÓGICO = new javax.swing.JTextField();
        jCheckBox_firma = new javax.swing.JCheckBox();
        jLabel_ESTUDIO1 = new javax.swing.JLabel();
        jLabel_p16 = new javax.swing.JLabel();
        txt_p16 = new javax.swing.JTextField();
        jLabel_Ki_67 = new javax.swing.JLabel();
        txt_Ki67 = new javax.swing.JTextField();
        ...
        getContentPane().add(txt_Reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 785, 210, -1));
        ...
        getContentPane().add(jLabel_Datos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 790, -1, -1));
        ...
        jLabel_ESPÉCIMEN.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_ESPÉCIMEN.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_ESPÉCIMEN.setText("ESPÉCIMEN:");
        getContentPane().add(jLabel_ESPÉCIMEN, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 635, -1, -1));

        txt_ESPÉCIMEN.setBackground(new java.awt.Color(153, 153, 255));
        txt_ESPÉCIMEN.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_ESPÉCIMEN.setForeground(new java.awt.Color(255, 255, 255));
        txt_ESPÉCIMEN.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_ESPÉCIMEN.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_ESPÉCIMEN, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 630, 210, -1));

        jLabel_ESTUDIO.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_ESTUDIO.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_ESTUDIO.setText("ESTUDIO");
        getContentPane().add(jLabel_ESTUDIO, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 664, -1, -1));

        txt_ESTUDIOHISTOPATOLÓGICO.setBackground(new java.awt.Color(153, 153, 255));
        txt_ESTUDIOHISTOPATOLÓGICO.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_ESTUDIOHISTOPATOLÓGICO.setForeground(new java.awt.Color(255, 255, 255));
        txt_ESTUDIOHISTOPATOLÓGICO.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_ESTUDIOHISTOPATOLÓGICO.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_ESTUDIOHISTOPATOLÓGICO, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 665, 210, -1));
        ...
        getContentPane().add(jCheckBox_firma, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 830, -1, -1));

        jLabel_ESTUDIO1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_ESTUDIO1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_ESTUDIO1.setText("HISTOPATOLÓGICO:");
        getContentPane().add(jLabel_ESTUDIO1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 677, -1, -1));

        jLabel_p16.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_p16.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_p16.setText("p16:");
        getContentPane().add(jLabel_p16, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 706, -1, -1));

        txt_p16.setBackground(new java.awt.Color(153, 153, 255));
        txt_p16.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_p16.setForeground(new java.awt.Color(255, 255, 255));
        txt_p16.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_p16.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_p16, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 700, 210, -1));

        jLabel_Ki_67.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_Ki_67.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_Ki_67.setText("Ki-67:");
        getContentPane().add(jLabel_Ki_67, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 741, -1, -1));

        txt_Ki67.setBackground(new java.awt.Color(153, 153, 255));
        txt_Ki67.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_Ki67.setForeground(new java.awt.Color(255, 255, 255));
        txt_Ki67.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_Ki67.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_Ki67, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 735, 210, -1));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 900));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, ESPÉCIMEN, ESTUDIOHISTO, p16, Ki67,Reporte_generado1; 
      ...
      ESPÉCIMEN = txt_ESPÉCIMEN.getText().trim();
      ESTUDIOHISTO = txt_ESTUDIOHISTOPATOLÓGICO.getText().trim();
      p16 = txt_p16.getText().trim();
      Ki67 = txt_Ki67.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(ESPÉCIMEN.equals("")) {
           txt_ESPÉCIMEN.setBackground(Color.red);
           validacion++;     
       }
       if(ESTUDIOHISTO.equals("")) {
           txt_ESTUDIOHISTOPATOLÓGICO.setBackground(Color.red);
           validacion++;     
       }
      if(p16.equals("")) {
           txt_p16.setBackground(Color.red);
           validacion++;     
       }
       if(Ki67.equals("")) {
           txt_Ki67.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into HLA_A_B_C_DQ_DR values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
             ...
             pst.setString(13, ESPÉCIMEN);
             pst.setString(14, ESTUDIOHISTO);
             pst.setString(15, p16);
             pst.setString(16, Ki67);
             ...
             txt_ESPÉCIMEN.setBackground(Color.green);
             txt_ESTUDIOHISTOPATOLÓGICO.setBackground(Color.green);
             txt_p16.setBackground(Color.green);
             txt_Ki67.setBackground(Color.green);
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      if(p16.equals("")) {
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update HLA_A_B_C_DQ_DR set Fecha_entrega=?, Hora=?, Observaciones=?, ESPÉCIMEN=?, ESTUDIO_HISTOPATOLÓGICO=?, p16=?, Ki67=?,ultima_modificacion=? " 
             ...
             pst.setString(4, ESPÉCIMEN);
             pst.setString(5, ESTUDIOHISTO);
             pst.setString(6, p16);
             pst.setString(7, Ki67);
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
           ...
           try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update HLA_A_B_C_DQ_DR set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        resultado.setIndentationLeft(400);
        resultado.setSpacingAfter(-3);
        documento.add(resultado);
        
   
        
        Chunk chunk2 = new Chunk("Estudio del p16 y Ki-67", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: Inmunohistoquímica" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        metodo.setSpacingBefore(2);
        metodo.setIndentationLeft(17);
        metodo.setSpacingAfter(-3);
        documento.add(metodo);
      
        Paragraph  ESPÉCIMEN = new  Paragraph ("ESPÉCIMEN" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        ESPÉCIMEN.setSpacingBefore(10);
        ESPÉCIMEN.setIndentationLeft(17);
        ESPÉCIMEN.setSpacingAfter(-3);
        documento.add(ESPÉCIMEN);
        
        Paragraph ESPÉCIMENR = new  Paragraph (txt_ESPÉCIMEN.getText(), FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ESPÉCIMENR.setSpacingBefore(-12);
        ESPÉCIMENR.setIndentationLeft(420);
        ESPÉCIMENR.setSpacingAfter(-3);
        documento.add(ESPÉCIMENR);
        
   
      
        Paragraph ESTUDIOHISTO = new  Paragraph ("ESTUDIO HISTOPATOLÓGICO" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        ESTUDIOHISTO.setSpacingBefore(10);
        ESTUDIOHISTO.setIndentationLeft(17);
        ESTUDIOHISTO.setSpacingAfter(-3);
        documento.add(ESTUDIOHISTO);
        
        Paragraph ESTUDIOHISTOR = new  Paragraph (txt_ESTUDIOHISTOPATOLÓGICO.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ESTUDIOHISTOR.setSpacingBefore(-11);
        ESTUDIOHISTOR.setIndentationLeft(420);
        ESTUDIOHISTOR.setSpacingAfter(-3);
        documento.add(ESTUDIOHISTOR);
        
        
         Paragraph p16 = new  Paragraph ("p16" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        p16.setSpacingBefore(10);
        p16.setIndentationLeft(17);
        p16.setSpacingAfter(-3);
        documento.add(p16);
        
        Paragraph p16R = new  Paragraph (txt_p16.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        p16R.setSpacingBefore(-11);
        p16R.setIndentationLeft(420);
        p16R.setSpacingAfter(-3);
        documento.add(p16R);
        
         Paragraph Ki67 = new  Paragraph ("Ki-67" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        Ki67.setSpacingBefore(10);
        Ki67.setIndentationLeft(17);
        Ki67.setSpacingAfter(-3);
        documento.add(Ki67);
        
        Paragraph Ki67R = new  Paragraph (txt_p16.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        Ki67R.setSpacingBefore(-11);
        Ki67R.setIndentationLeft(420);
        Ki67R.setSpacingAfter(-3);
        documento.add(Ki67R);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HLA_A_B_C_DQ_DR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HLA_A_B_C_DQ_DR().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_ESPÉCIMEN;
    private javax.swing.JLabel jLabel_ESTUDIO;
    private javax.swing.JLabel jLabel_ESTUDIO1;
    private javax.swing.JLabel jLabel_Ki_67;
    ...
    private javax.swing.JLabel jLabel_p16;
    private javax.swing.JLabel jLabel_sexo;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JTextPane jTextPane_indicaciones;
    private javax.swing.JTextField txt_ESPÉCIMEN;
    private javax.swing.JTextField txt_ESTUDIOHISTOPATOLÓGICO;
    private javax.swing.JTextField txt_Ki67;
    ...
    private javax.swing.JTextField txt_p16;
