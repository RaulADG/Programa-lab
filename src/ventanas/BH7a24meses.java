 ...
 * @author raula
 */
public class BH7a24meses extends javax.swing.JFrame {
    ...
    public BH7a24meses() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BH7a24meses where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BH7a24meses values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BH7a24meses set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
          ...
          try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BH7a24meses set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      BaseFont baseFontL = BaseFont.createFont("fonts/monotype-corsiva.ttf", BaseFont.WINANSI, BaseFont.EMBEDDED);
        ...
        if(HematocritoRe>=34 && HematocritoRe<=42){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>34 && HematocritoRe<42){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>42 && HematocritoRe<100){
        HematocritoR3.setIndentationLeft((float) 324);
        documento.add(HematocritoR3);
        } else {
        if(HematocritoRe>=43 && HematocritoRe<=99) {  
        ...
        Paragraph Num41111 = new  Paragraph ("42" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41112 = new  Paragraph ("42" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num41113 = new  Paragraph ("42" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        NeutrófilosS1 .setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1200 && Neutrófilossegmentados1TT<=8200){
        ...
        NeutrófilosS2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1200){
        ...
        NeutrófilosS3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>8200){
        ...
        NeutrófilosSR1.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1200 && Neutrófilossegmentados1TT<=8200 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1200 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>8200 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1200 && Neutrófilossegmentados1TT<=8200 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR2P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<1200 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR3P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>8200 && Neutrófilossegmentados1TP>=10){
        ...
        Paragraph NeutrófilosSVref = new  Paragraph ("1200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref1 = new  Paragraph ("1200" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref2 = new  Paragraph ("1200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref3 = new  Paragraph ("1200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref2 = new  Paragraph ("8200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref21 = new  Paragraph ("8200" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref22 = new  Paragraph ("8200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref23 = new  Paragraph ("8200" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>=3000 && Linfocitos1TT<=9500){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<3000){
        ...
        if(Linfocitos1TT>=3000 && Linfocitos1TT<=9500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<3000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>9500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=3000 && Linfocitos1TT<=9500 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<3000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>9500 && Linfocitos1TP>=10){
        ...
        Paragraph Linfocitosref = new  Paragraph ("3000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref1 = new  Paragraph ("3000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref2 = new  Paragraph ("3000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref3 = new  Paragraph ("3000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("9500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("9500" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("9500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("9500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BH7a24meses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BH7a24meses().setVisible(true);
            }
        });
    }
