 ...
 * @author raula
 */
public class Estudio_paciente extends javax.swing.JFrame {
    ...
    Connection cn = Conexion.conectar();
     protected void cargarTabla(){
            ...
            String query= "select * from estudios where id_paciente = '"
                                  + IDpaciente_update + "'";
            ...
            try {
              ...
              while(rs.next()==true) {
               ...
               datos[1]=rs.getString("NdeFolio");
               datos[2]=rs.getString("clave_estudio");
               datos[3]=rs.getString("nombre_estudio");
               datos[4]=rs.getString("dia_entrega");
               datos[5]=rs.getString("indicacion_estudio");
               datos[6]=rs.getString("tipo_muestra");
               datos[7]=rs.getString("costo_estudio");
               datos[8]=rs.getString("estatus");
               model.addRow(datos);
              }
               jTable_estudios.setModel(model);
            } catch (Exception e){       
              }             
}
protected void buscarTablaE(String NdeFolio, String clave_estudio, String estatus){
            model.setRowCount(0);
            String datos[]= new String[9];
            ...
            //Si la clave no esta vacio
            if(clave_estudio.isEmpty()==false){
               where=where+" and clave_estudio='"+clave_estudio+"' ";
            }
            //Si el estatus no esta vacio
            if(estatus.isEmpty()==false){
               where=where+" and estatus='"+estatus+"' ";
            }
    ...
    public Estudio_paciente() {
        ...
        IDpaciente_update = GestionarPacientes.IDpaciente_update;
            ...
            model.addColumn("Días de entrega");
        ...
        try {
            ...
            jTable_estudios.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {

              if(e.getClickCount()==2){
                 int fila = jTable_estudios.getSelectedRow();
            
           
                  String IDestudio_up = jTable_estudios.getValueAt(fila, 0).toString();
                  IDestudio =Integer.parseInt(IDestudio_up);
                  InformacionEstudio informacionEstudio = new InformacionEstudio();
                  informacionEstudio.setVisible(true);
                  dispose(); 
    ...
    private void initComponents() {
        ...
        jTable_estudios = new javax.swing.JTable();
        jButton_Eliminar = new javax.swing.JButton();
        jLabel_BNEstudio = new javax.swing.JLabel();
        jText_BEstudio = new javax.swing.JTextField();
        jLabel_BClave = new javax.swing.JLabel();
        jText_BClave = new javax.swing.JTextField();
        jLabel_BEstatus = new javax.swing.JLabel();
        jText_BEstatus = new javax.swing.JTextField();
        ...
        jTable_estudios.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null, null, null, null, null, null, null}
            },
            new String [] {
                "ID estudio", "N. de folio", "Clave", "Tipo de estudio", "Días de entrega", "Indicaciones", "Tipo de muestra", "Costo", "Estatus", "Title 10"
            }
        ));
        jScrollPane_estudios.setViewportView(jTable_estudios);
        ...
        jLabel_BClave.setText("Clave");
        getContentPane().add(jLabel_BClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, -1, -1));

        jText_BClave.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(jText_BClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 90, 130, 30));

        jLabel_BEstatus.setText("Estatus");
        getContentPane().add(jLabel_BEstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, -1, -1));

        jText_BEstatus.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(jText_BEstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 90, 130, 30));
    ...
    private void jButton_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_EliminarActionPerformed
        int fila = jTable_estudios.getSelectedRow();
        String identidad = jTable_estudios.getValueAt(fila, 0).toString();
        try {
            Connection cn2 = Conexion.conectar();
            PreparedStatement pst2 = cn2.prepareStatement(
                "delete from estudios where id_estudio = '"+identidad+"'" );
            pst2.executeUpdate();
            cargarTabla();
        } catch (SQLException e) {
    ...
    private void jButton_BuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_BuscarActionPerformed
     buscarTablaE(jText_BEstudio.getText(), jText_BClave.getText(),jText_BEstatus.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estudio_paciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Estudio_paciente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_BClave;
    private javax.swing.JLabel jLabel_BEstatus;
    private javax.swing.JLabel jLabel_BNEstudio;
    private javax.swing.JLabel jLabel_Titulo;
    private javax.swing.JLabel jLabel_Wallpaper;
    private javax.swing.JScrollPane jScrollPane_estudios;
    private javax.swing.JTable jTable_estudios;
    private javax.swing.JTextField jText_BClave;
    private javax.swing.JTextField jText_BEstatus;
