 ...
 * @author raula
 */
public class CargaviralVIH extends javax.swing.JFrame {
...
String user = "", nom_paciente = "";
 ...
 Calendar calendario;
    ...
    public CargaviralVIH() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from CargaviralVIH where ID_estudio = '" + IEstudio + "'");
          ...
          if (rs2.next()) {
            ...
            txt_Logaritmo.setText(rs2.getString("Logaritmo_VIH"));
            txt_CopiasmL.setText(rs2.getString("CopiasmL_VIH"));
          }
    ...
    private void initComponents() {
        ...
        txt_Logaritmo = new javax.swing.JTextField();
        jLabel_CopiasmL = new javax.swing.JLabel();
        txt_CopiasmL = new javax.swing.JTextField();
        ...
        getContentPane().add(txt_Reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 730, 210, -1));
        ...
        getContentPane().add(jLabel_Datos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 740, -1, -1));
        ...
        jLabel_Logaritmo.setText("Logaritmo:");
        getContentPane().add(jLabel_Logaritmo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 635, -1, -1));

        txt_Logaritmo.setBackground(new java.awt.Color(153, 153, 255));
        txt_Logaritmo.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_Logaritmo.setForeground(new java.awt.Color(255, 255, 255));
        txt_Logaritmo.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_Logaritmo.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_Logaritmo, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 630, 210, -1));

        jLabel_CopiasmL.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_CopiasmL.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_CopiasmL.setText("Copias/mL:");
        getContentPane().add(jLabel_CopiasmL, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 670, -1, -1));

        txt_CopiasmL.setBackground(new java.awt.Color(153, 153, 255));
        txt_CopiasmL.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_CopiasmL.setForeground(new java.awt.Color(255, 255, 255));
        txt_CopiasmL.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_CopiasmL.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_CopiasmL, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 665, 210, -1));
        ...
        getContentPane().add(jCheckBox_firma, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 770, -1, -1));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 600, 850));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, logaritmo, copiasmL,Reporte_generado1; 
      ...
      logaritmo = txt_Logaritmo.getText().trim();
      copiasmL = txt_CopiasmL.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(logaritmo.equals("")) {
           txt_Logaritmo.setBackground(Color.red);
           validacion++;     
       }
       if(copiasmL.equals("")) {
           txt_CopiasmL.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into CargaviralVIH values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
             ...
             pst.setString(13, logaritmo);
             pst.setString(14, copiasmL);
             ...
             txt_Logaritmo.setBackground(Color.green);
             txt_CopiasmL.setBackground(Color.green);
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update CargaviralVIH set Fecha_entrega=?, Hora=?, Observaciones=?, Logaritmo_VIH=?, CopiasmL_VIH=?,ultima_modificacion=? " 
                   + "where ID_estudio = '" + IEstudio + "'");
 
             pst.setString(1, fechaEntrega);
             pst.setString(2, hora);
             pst.setString(3, observaciones);
             pst.setString(4, logaritmo);
             pst.setString(5, copiasmL);
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
           ...
           try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update CargaviralVIH set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        Chunk chunk2 = new Chunk("Carga viral para VIH", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: PCR CON TRANSCRIPCIÓN INVERSA (RT-PCR) Tiempo real" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        metodo.setSpacingBefore(2);
        metodo.setIndentationLeft(17);
        metodo.setSpacingAfter(-3);
        documento.add(metodo);
      
        Paragraph log = new  Paragraph ("Logaritmo" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        log.setSpacingBefore(10);
        log.setIndentationLeft(17);
        log.setSpacingAfter(-3);
        documento.add(log);
        
        Paragraph log1 = new  Paragraph (txt_Logaritmo.getText(), FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        log1.setSpacingBefore(-12);
        log1.setIndentationLeft(255);
        log1.setSpacingAfter(-3);
        documento.add(log1);
        
        Paragraph logM = new  Paragraph ("Menor de 1.6", FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        logM.setSpacingBefore(-12);
        logM.setIndentationLeft(420);
        logM.setSpacingAfter(-3);
        documento.add(logM);
      
        Paragraph copias = new  Paragraph ("Copias/mL" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        copias.setSpacingBefore(0);
        copias.setIndentationLeft(17);
        copias.setSpacingAfter(-3);
        documento.add(copias);
        
        Paragraph copiasR = new  Paragraph (txt_CopiasmL.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        copiasR.setSpacingBefore(-11);
        copiasR.setIndentationLeft(255);
        copiasR.setSpacingAfter(-3);
        documento.add(copiasR);
        
        Paragraph copiasM = new  Paragraph ("Menor de 40.0" , FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        copiasM.setSpacingBefore(-11);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargaviralVIH.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargaviralVIH().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txt_CopiasmL;
    private javax.swing.JTextField txt_Logaritmo;
