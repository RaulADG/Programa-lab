 ...
 * @author raula
 */
public class BHNeonato0a1día extends javax.swing.JFrame {
    ...
    public BHNeonato0a1día() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BHNeonato0a1día where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BHNeonato0a1día values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BHNeonato0a1día set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
          ...
          try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BHNeonato0a1día set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
       ...
       float Nfolio = 447, Nfolio1 = 442, Nfolio2 = 436, Nfolio3 = 430, Nfolio4 = 424, Nfolio5 = 419, Nfolio6 = 413;
        ...
        if(HemoglobinaRe>=14 && HemoglobinaRe<=20){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>14 && HemoglobinaRe<20){
        ...
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>=29 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<=37){
        documento.add(CHCM1);
        } 
        ...
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>37){
        documento.add(CHCM2);
        } 
        ...
        if(txt_ConcentraciónMediadeHemoglobinaCorpuscularCHCM.getText().contains(".") && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>29 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<37){
        ...
        if(txt_ConcentraciónMediadeHemoglobinaCorpuscularCHCM.getText().contains(".") && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>37 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<100){
        CHCMR3.setIndentationLeft((float) 324);
        documento.add(CHCMR3);
        } else {
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>=38 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<=99) {  
        ...
        Paragraph CHCMref12 = new  Paragraph ("37" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph CHCMref13 = new  Paragraph ("37" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph CHCMref14 = new  Paragraph ("37" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Leucocitostotales1.setSpacingAfter(-3);
          ...
          if(LeucocitostotalesTT>=13000 && LeucocitostotalesTT<=38000){
        ...
        Leucocitostotales12.setSpacingAfter(-3);  
          ...
          if(LeucocitostotalesTT>=10 && LeucocitostotalesTT<13000){
        ...
        Paragraph LeucocitostotalesV = new  Paragraph ("13000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        LeucocitostotalesV.setSpacingBefore((float) -12);
        LeucocitostotalesV.setIndentationLeft((float) 433.5);
        ...
        Paragraph LeucocitostotalesV1 = new  Paragraph ("13000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        LeucocitostotalesV1.setSpacingBefore((float) -12);
        LeucocitostotalesV1.setIndentationLeft((float) 433.5);
        ...
        Paragraph LeucocitostotalesV12 = new  Paragraph ("13000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        LeucocitostotalesV12.setSpacingBefore((float) -12);
        LeucocitostotalesV12.setIndentationLeft((float) 433.5);
        ...
        Paragraph LeucocitostotalesV123 = new  Paragraph ("13000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        LeucocitostotalesV123.setSpacingBefore((float) -12);
        LeucocitostotalesV123.setIndentationLeft((float) 433.5);
        ...
        Paragraph LeucocitostotalesV2 = new  Paragraph ("38000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV21 = new  Paragraph ("38000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV212 = new  Paragraph ("38000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2123 = new  Paragraph ("38000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        NeutrófilosS1 .setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=5000 && Neutrófilossegmentados1TT<=27000){
        ...
        NeutrófilosS2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<5000){
        ...
        NeutrófilosS3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>27000){
        ...
        NeutrófilosSR1.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=5000 && Neutrófilossegmentados1TT<=27000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<5000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>27000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=5000 && Neutrófilossegmentados1TT<=27000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR2P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<5000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR3P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>27000 && Neutrófilossegmentados1TP>=10){
        ...
        Paragraph NeutrófilosSVref = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref1 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref2 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref3 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref2 = new  Paragraph ("27000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        NeutrófilosSref2.setSpacingBefore((float) -12);
        NeutrófilosSref2.setIndentationLeft((float) 503);
        ...
        Paragraph NeutrófilosSref21 = new  Paragraph ("27000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        NeutrófilosSref21.setSpacingBefore((float) -12);
        NeutrófilosSref21.setIndentationLeft((float) 503);
        ...
        Paragraph NeutrófilosSref22 = new  Paragraph ("27000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        NeutrófilosSref22.setSpacingBefore((float) -12);
        NeutrófilosSref22.setIndentationLeft((float) 503);
        ...
        Paragraph NeutrófilosSref23 = new  Paragraph ("27000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        NeutrófilosSref23.setSpacingBefore((float) -12);
        NeutrófilosSref23.setIndentationLeft((float) 503);
        ...
        NeutrófilosB1.setSpacingAfter(-3);
          ...
          if(Neutrófilosenbanda1TT>=10 && Neutrófilosenbanda1TT<=1300){
        ...
        NeutrófilosBR1.setSpacingAfter(-3);
          ...
          if(Neutrófilosenbanda1TT>=10 && Neutrófilosenbanda1TT<=1300 && Neutrófilosenbanda1TP<=9){
        ...
        NeutrófilosBR2.setSpacingAfter(-3);
          ...
          if(Neutrófilosenbanda1TT>1300 && Neutrófilosenbanda1TP<=9){
        ...
        NeutrófilosBR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilosenbanda1TT>=10 && Neutrófilosenbanda1TT<=1300 && Neutrófilosenbanda1TP>=10){
        ...
        NeutrófilosBR2P.setSpacingAfter(-3);
          ...
          if(Neutrófilosenbanda1TT>1300 && Neutrófilosenbanda1TP>=10){
        ...
        Paragraph NeutrófilosBref21 = new  Paragraph ("1300" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosBref212 = new  Paragraph ("1300" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosBref23 = new  Paragraph ("1300" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11000){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>11000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>11000 && Linfocitos1TP>=10){
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("11000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("11000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("11000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("11000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BHNeonato0a1día.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BHNeonato0a1día().setVisible(true);
            }
        });
    }
