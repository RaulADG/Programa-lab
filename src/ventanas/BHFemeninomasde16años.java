 ...
 * @author raula
 */
public class BHFemeninomasde16años extends javax.swing.JFrame {
...
String user = "", nom_paciente = "";
    ...
    public BHFemeninomasde16años() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BHFemeninomasde16años where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_ImprimirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 700, 150, 20));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BHFemeninomasde16años values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BHFemeninomasde16años set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
          ...
          try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BHFemeninomasde16años set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        if(EritrocitosRe>=3.6 && EritrocitosRe<=5.2){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>=0 && EritrocitosRe<3.6){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>3.6 && EritrocitosRe<=5.2){
        copiasR1D.setIndentationLeft((float) 326);
        documento.add(copiasR1D);
        } else {
        if(EritrocitosRe>=4 && EritrocitosRe<=5) {  
        ...
        Paragraph Num511 = new  Paragraph ("3.6" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num512 = new  Paragraph ("3.6" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num513 = new  Paragraph ("3.6" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HemoglobinaRe>=12 && HemoglobinaRe<=15){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>12 && HemoglobinaRe<15){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>15 && HemoglobinaRe<100){
        ...
        Paragraph Num4111 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4112 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num4113 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>=1000 && Linfocitos1TT<=4800){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<1000){
        ...
        if(Linfocitos1TT>=1000 && Linfocitos1TT<=4800 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<1000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>4800 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=1000 && Linfocitos1TT<=4800 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<1000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>4800 && Linfocitos1TP>=10){
        ...
        Paragraph Linfocitosref = new  Paragraph ("1000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref1 = new  Paragraph ("1000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref2 = new  Paragraph ("1000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref3 = new  Paragraph ("1000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("4800" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("4800" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("4800" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("4800" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BHFemeninomasde16años.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BHFemeninomasde16años().setVisible(true);
            }
        });
    }
