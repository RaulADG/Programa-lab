 ...
 * @author raula
 */
public class DimeroD extends javax.swing.JFrame {
...
String user = "", nom_paciente = "";
    ...
    public DimeroD() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from DimeroD where ID_estudio = '" + IEstudio + "'");
          ...
          if (rs2.next()) {
            ...
            txt_DimeroD.setText(rs2.getString("Dimerod"));
 ...
 @Override
    ...
    private void initComponents() {
        ...
        txt_DimeroD = new javax.swing.JTextField();
        ...
        getContentPane().add(jButton_GuardarDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 700, 130, -1));
        ...
        getContentPane().add(txt_Reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 755, 210, -1));
        ...
        getContentPane().add(jLabel_Datos, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 760, -1, -1));
        ...
        getContentPane().add(jButton_ActualizarDatos, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 700, 130, -1));
        ...
        getContentPane().add(jButton_ImprimirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 700, 130, -1));
        ...
        jLabel_Logaritmo.setText("Dímero D");
        ...
        jLabel_CopiasmL.setText("Método: Quimioluminiscencia ");
        ...
        getContentPane().add(jCheckBox_firma, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 820, -1, -1));

        txt_DimeroD.setBackground(new java.awt.Color(153, 153, 255));
        txt_DimeroD.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_DimeroD.setForeground(new java.awt.Color(255, 255, 255));
        txt_DimeroD.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_DimeroD.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_DimeroD, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 643, 210, -1));

        jLabel_Wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FondoUni.png"))); // NOI18N
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 710, 910));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, DimeroDR,Reporte_generado1; 
      ...
      DimeroDR = txt_DimeroD.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(DimeroDR.equals("")) {
           txt_DimeroD.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             pst.setString(13, DimeroDR);
             pst.setString(14, user);
             pst.setString(15, Reporte_generado1);
             ...
             txt_DimeroD.setBackground(Color.green);
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update DimeroD set Fecha_entrega=?, Hora=?, Observaciones=?, Dimerod=?, ultima_modificacion=? " 
                   + "where ID_estudio = '" + IEstudio + "'");
    
             pst.setString(1, fechaEntrega);
             pst.setString(2, hora);
             pst.setString(3, observaciones);
             pst.setString(4, DimeroDR);
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
       ...
       try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update DimeroD set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        valores.setSpacingBefore((float) -13.5);
        ...
        DímeroR = Double.parseDouble(txt_DimeroD.getText());
        
        Chunk chunk2 = new Chunk("Dímero D", FontFactory.getFont("arial", 12,Font.NORMAL, BaseColor.BLACK));
        ...
        Chunk chunk_1 = new Chunk("Dímero D", FontFactory.getFont("arial", 12,Font.BOLD, BaseColor.BLACK));
        ...
        if(DímeroR>=0 && DímeroR<=500){
        documento.add(chunk1);
        }

        Chunk chunk_2 = new Chunk("Dímero D", FontFactory.getFont("arial", 12,Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: Quimioluminiscencia" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Tiempopro = new  Paragraph (txt_DimeroD.getText() + " ng/mL" , FontFactory.getFont("arial", 12, Font.NORMAL, BaseColor.BLACK));
        Tiempopro.setSpacingBefore(-29);
        Tiempopro.setSpacingAfter(-3);
        
        if(txt_DimeroD.getText().contains(".") && DímeroR>0 && DímeroR<10){
        left = left - 4;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } else {
        if(DímeroR>=0 && DímeroR<=9){
        left = left;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } }

        if(txt_DimeroD.getText().contains(".") && DímeroR>10 && DímeroR<100){
        left = left - 7;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } else {
        if(DímeroR>=10 && DímeroR<=99){
        left = left - 3;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } }
        ...
        if(txt_DimeroD.getText().contains(".") && DímeroR>100 && DímeroR<500){
        left = left - 10;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } else {
        if(DímeroR>=100 && DímeroR<=499){
        left = left - 6;
        Tiempopro.setIndentationLeft(left);
        documento.add(Tiempopro);
        } }

        Paragraph Tiempopro1 = new  Paragraph (txt_DimeroD.getText() + " ng/mL" , FontFactory.getFont("arial", 12, Font.BOLD, BaseColor.BLACK));
        Tiempopro1.setSpacingBefore(-29);
        Tiempopro1.setSpacingAfter(-3);

        if(txt_DimeroD.getText().contains(".") && DímeroR>1000 && DímeroR<10000){
        left = left - 13;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(DímeroR>=1000 && DímeroR<=9999){
        left = left - 9;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }

        if(txt_DimeroD.getText().contains(".") && DímeroR>10000 && DímeroR<100000){
        left = left - 16;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(DímeroR>=10000 && DímeroR<=99999){
        left = left - 12;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }
        ...
        documento.add(Tiempopro1);
         ...
         //negativo
        if(txt_DimeroD.getText().contains(".") && txt_DimeroD.getText().contains("-") && DímeroR>-9 && DímeroR<0){
        left = left - 7;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(txt_DimeroD.getText().contains("-") && DímeroR>=-9 && DímeroR<=0){
        left = left - 3;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }
        ...
        if(txt_DimeroD.getText().contains(".") && txt_DimeroD.getText().contains("-") && DímeroR>-1000 && DímeroR<-100){
        left = left - 13;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(txt_DimeroD.getText().contains("-") && DímeroR>=-999 && DímeroR<=-100){
        left = left - 9;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }
        
        if(txt_DimeroD.getText().contains(".") && txt_DimeroD.getText().contains("-") && DímeroR>-10000 && DímeroR<-1000){
        left = left - 16;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(txt_DimeroD.getText().contains("-") && DímeroR>=-9999 && DímeroR<=-1000){
        left = left - 12;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }
        
        if(txt_DimeroD.getText().contains(".") && txt_DimeroD.getText().contains("-") && DímeroR>-100000 && DímeroR<-10000){
        left = left - 22;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } else {
        if(txt_DimeroD.getText().contains("-") && DímeroR>=-99999 && DímeroR<=-10000){
        left = left - 18;
        Tiempopro1.setIndentationLeft(left);
        documento.add(Tiempopro1);
        } }
        ...
        Paragraph logM = new  Paragraph ("0	           500", FontFactory.getFont("arial", 12, Font.BOLD, BaseColor.BLACK));
        logM.setSpacingBefore(-14);
        ...
        Paragraph logM1 = new  Paragraph ("0	            500", FontFactory.getFont("arial", 12, Font.NORMAL, BaseColor.BLACK));
        logM1.setSpacingBefore(-14);
        ...
        Paragraph logM2 = new  Paragraph ("0	            500", FontFactory.getFont("arial", 12, Font.BOLD, BaseColor.BLACK));
        logM2.setSpacingBefore(-14);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DimeroD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txt_DimeroD;
