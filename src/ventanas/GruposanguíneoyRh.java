 ...
 * @author raula
 */
public class GruposanguíneoyRh extends javax.swing.JFrame {
...
String user = "", nom_paciente = "";
 ...
 Calendar calendario;
    ...
    public GruposanguíneoyRh() {
        ...
        try {
          ...
          if (rs2.next()) {
            ...
            txt_GpS.setText(rs2.getString("Gruposanguíneo"));
            txt_FRh.setText(rs2.getString("FactorRh"));
    ...
    private void initComponents() {
        ...
        txt_GpS = new javax.swing.JTextField();
        jLabel_FRh = new javax.swing.JLabel();
        txt_FRh = new javax.swing.JTextField();
        ...
        jLabel_Titulo.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        ...
        getContentPane().add(txt_Reporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 740, 210, -1));
        ...
        getContentPane().add(jLabel_Datos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 750, -1, -1));
        ...
        jLabel_GpS.setText("Grupo sanguíneo:");
        getContentPane().add(jLabel_GpS, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 635, -1, -1));

        txt_GpS.setBackground(new java.awt.Color(153, 153, 255));
        txt_GpS.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_GpS.setForeground(new java.awt.Color(255, 255, 255));
        txt_GpS.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_GpS.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_GpS, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 630, 210, -1));

        jLabel_FRh.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_FRh.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_FRh.setText("Linfocitos totales:");
        getContentPane().add(jLabel_FRh, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 670, -1, -1));

        txt_FRh.setBackground(new java.awt.Color(153, 153, 255));
        txt_FRh.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_FRh.setForeground(new java.awt.Color(255, 255, 255));
        txt_FRh.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_FRh.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_FRh, new org.netbeans.lib.awtextra.AbsoluteConstraints(145, 665, 210, -1));
        ...
        getContentPane().add(jCheckBox_firma, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 800, -1, -1));

        jLabel_Wallpaper.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FondoUni.png"))); // NOI18N
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 1050));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, Gruposanguíneo, FactorRh, Reporte_generado1; 
      ...
      Gruposanguíneo = txt_GpS.getText().trim();
      FactorRh = txt_FRh.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(Gruposanguíneo.equals("")) {
           txt_GpS.setBackground(Color.red);
           validacion++;     
       }
       if(FactorRh.equals("")) {
           txt_FRh.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into GruposanguíneoyRh values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
             ...
             pst.setString(13, Gruposanguíneo);
             pst.setString(14, FactorRh);
             ...
             txt_GpS.setBackground(Color.green);
             txt_FRh.setBackground(Color.green);
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update GruposanguíneoyRh set Fecha_entrega=?, Hora=?, Observaciones=?, Gruposanguíneo=?, FactorRh=?, ultima_modificacion=? " 
             ...
             pst.setString(4, Gruposanguíneo);
             pst.setString(5, FactorRh);
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
       ...
       try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update GruposanguíneoyRh set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        Chunk chunk2 = new Chunk("Grupo sanguíneo y factor Rh", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: Aglutinación específica" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        metodo.setSpacingBefore(2);
        metodo.setIndentationLeft(17);
        metodo.setSpacingAfter(-3);
        documento.add(metodo);

        Paragraph LeucocitosT = new  Paragraph ("Grupo sanguíneo" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        float left = 255, left1 = 255;
 
        Paragraph GruposanguíneoR = new  Paragraph (txt_GpS.getText(), FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        GruposanguíneoR.setSpacingBefore((float) -11.5);
        GruposanguíneoR.setSpacingAfter(-3);
        GruposanguíneoR.setIndentationLeft(left);
        documento.add(GruposanguíneoR);

        Paragraph LinfocitosT = new  Paragraph ("Factor Rh" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        LinfocitosT.setSpacingBefore(1);
        LinfocitosT.setIndentationLeft(17);
        LinfocitosT.setSpacingAfter(-3);
        documento.add(LinfocitosT);
       
        Paragraph Linfocitostotales = new  Paragraph (txt_FRh.getText() , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        Linfocitostotales.setSpacingBefore(-11);
        Linfocitostotales.setSpacingAfter((float) -3.5);
        Linfocitostotales.setIndentationLeft(left1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GruposanguíneoyRh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GruposanguíneoyRh().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel jLabel_FRh;
    ...
    private javax.swing.JTextField txt_FRh;
    private javax.swing.JTextField txt_GpS;
