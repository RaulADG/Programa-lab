 ...
 * @author raula
 */
public class FTA_ABS extends javax.swing.JFrame {
...
Calendar calendario;
    ...
    public FTA_ABS() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from FTA_ABS where ID_estudio = '" + IEstudio + "'");
          ...
          if (rs2.next()) {
            ...
            txt_FTA_ABS.setText(rs2.getString("FTA_ABS"));
    ...
    private void initComponents() {
        ...
        txt_FTA_ABS = new javax.swing.JTextField();
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, 620, 190));
        ...
        jLabel_Logaritmo.setText("FTA-ABS:");
        getContentPane().add(jLabel_Logaritmo, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 635, -1, -1));

        txt_FTA_ABS.setBackground(new java.awt.Color(153, 153, 255));
        txt_FTA_ABS.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        txt_FTA_ABS.setForeground(new java.awt.Color(255, 255, 255));
        txt_FTA_ABS.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txt_FTA_ABS.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        getContentPane().add(txt_FTA_ABS, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 630, 210, -1));
        ...
        getContentPane().add(jCheckBox_firma, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 750, -1, -1));
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 680, 820));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      String NoFolio, ClaveE, empresa, nombre, apellido, edad, sexo, nombremedico, fechaEntrega, hora, horaF1, observaciones, FTA_ABS,Reporte_generado1; 
      ...
      FTA_ABS = txt_FTA_ABS.getText().trim();
      ...
      Reporte_generado1 = "Si";
       ...
       if(FTA_ABS.equals("")) {
           txt_FTA_ABS.setBackground(Color.red);
           validacion++;     
       }
       ...
       try {
             ...
             txt_FTA_ABS.setBackground(Color.green);
         ...
         try {
          Connection cn2 = Conexion.conectar();
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from FTA_ABS where id_estudio = '" + IDestudio + "'");
          ResultSet rs2 = pst2.executeQuery();
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update FTA_ABS set Fecha_entrega=?, Hora=?, Observaciones=?, FTA_ABS=?,ultima_modificacion=? " 
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
           ...
           try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update FTA_ABS set Hora=?, ultima_modificacion=?"
     ...
     com.itextpdf.text.Image logo = com.itextpdf.text.Image.getInstance("images/LogoT.jpg");
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        resultado.setIndentationLeft(330);
        ...
        Chunk chunk2 = new Chunk("Absorción de anticuerpos trepónemicos fluorescentes", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Chunk chunk3 = new Chunk("FTA-ABS", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: Fluorescencia" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph FTAABS = new  Paragraph (txt_FTA_ABS.getText(), FontFactory.getFont("arial", 11, Font.BOLD, BaseColor.BLACK));
        FTAABS.setSpacingBefore(-40);
        FTAABS.setIndentationLeft(335);
        FTAABS.setSpacingAfter(-3);
  
        Paragraph FTAABS1 = new  Paragraph (txt_FTA_ABS.getText(), FontFactory.getFont("arial", 11, Font.NORMAL, BaseColor.BLACK));
        FTAABS1.setSpacingBefore(-40);
        FTAABS1.setIndentationLeft(335);
        FTAABS1.setSpacingAfter(-3);
        
        if(txt_FTA_ABS.getText().contains("Positivo")){
         documento.add(FTAABS);
        } else {
        if(txt_FTA_ABS.getText().contains("Negativo")){
          documento.add(FTAABS1);
        } else {
          documento.add(FTAABS1);
        }
          }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FTA_ABS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txt_FTA_ABS;
