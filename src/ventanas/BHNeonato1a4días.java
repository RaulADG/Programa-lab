 ...
 * @author raula
 */
public class BHNeonato1a4días extends javax.swing.JFrame {
    ...
    public BHNeonato1a4días() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BHNeonato1a4días where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BHNeonato1a4días values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BHNeonato1a4días set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
          ...
          try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BHNeonato1a4días set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        if(HemoglobinaRe>=15 && HemoglobinaRe<=23){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>10 && HemoglobinaRe<15){
        HemoglobinaR1.setIndentationLeft((float) 324);
        documento.add(HemoglobinaR1);
        } else {
        if(HemoglobinaRe>=10 && HemoglobinaRe<=14) {  
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>15 && HemoglobinaRe<23){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>23 && HemoglobinaRe<100){
        HemoglobinaR3.setIndentationLeft((float) 324);
        documento.add(HemoglobinaR3);
        } else {
        if(HemoglobinaRe>=24 && HemoglobinaRe<=99) {  
        ...
        Paragraph Num5111 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num5112 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num5113 = new  Paragraph ("15" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4111 = new  Paragraph ("23" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4112 = new  Paragraph ("23" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num4113 = new  Paragraph ("23" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(VolumenGlobularMedioVCMRe<95){
        documento.add(VCM);
        }
        ...
        if(VolumenGlobularMedioVCMRe>=95 && VolumenGlobularMedioVCMRe<=121){
        documento.add(VCM1);
        } 
        ...
        if(VolumenGlobularMedioVCMRe>121){
        documento.add(VCM2);
        } 
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>10 && VolumenGlobularMedioVCMRe<95){
        VCMR2.setIndentationLeft((float) 324);
        documento.add(VCMR2);
        } else {
        if(VolumenGlobularMedioVCMRe>=10 && VolumenGlobularMedioVCMRe<=94) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>95 && VolumenGlobularMedioVCMRe<100){
        VCMR3.setIndentationLeft((float) 324);
        documento.add(VCMR3);
        } else {
        if(VolumenGlobularMedioVCMRe>=95 && VolumenGlobularMedioVCMRe<=99) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>100 && VolumenGlobularMedioVCMRe<121){
        VCMR4.setIndentationLeft((float) 323);
        documento.add(VCMR4);
        } else {
        if(VolumenGlobularMedioVCMRe>=100 && VolumenGlobularMedioVCMRe<=121) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>121 && VolumenGlobularMedioVCMRe<1000){
        VCMR5.setIndentationLeft((float) 323);
        documento.add(VCMR5);
        } else {
        if(VolumenGlobularMedioVCMRe>=122 && VolumenGlobularMedioVCMRe<=999) {  
        ...
        Paragraph VCMref = new  Paragraph ("95" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref1 = new  Paragraph ("95" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph VCMref2 = new  Paragraph ("95" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref3 = new  Paragraph ("121" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref4 = new  Paragraph ("121" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph VCMref5 = new  Paragraph ("121" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Leucocitostotales1.setSpacingAfter(-3);
          ...
          if(LeucocitostotalesTT>=9400 && LeucocitostotalesTT<=34000){
        ...
        Leucocitostotales12.setSpacingAfter(-3);  
          ...
          if(LeucocitostotalesTT>=10 && LeucocitostotalesTT<9400){
        ...
        Paragraph LeucocitostotalesV = new  Paragraph ("9400" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV1 = new  Paragraph ("9400" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV12 = new  Paragraph ("9400" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV123 = new  Paragraph ("9400" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2 = new  Paragraph ("34000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV21 = new  Paragraph ("34000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV212 = new  Paragraph ("34000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2123 = new  Paragraph ("34000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        NeutrófilosS1 .setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=4000 && Neutrófilossegmentados1TT<=20000){
        ...
        NeutrófilosS2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<4000){
        ...
        NeutrófilosS3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>20000){
        ...
        NeutrófilosSR1.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=4000 && Neutrófilossegmentados1TT<=20000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR2.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<4000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>20000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=4000 && Neutrófilossegmentados1TT<=20000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR2P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=10 && Neutrófilossegmentados1TT<4000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR3P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>20000 && Neutrófilossegmentados1TP>=10){
        ...
        Paragraph NeutrófilosSVref = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref1 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref2 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSVref3 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref2 = new  Paragraph ("20000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref21 = new  Paragraph ("20000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref22 = new  Paragraph ("20000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref23 = new  Paragraph ("20000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11500){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>11500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=11500 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>11500 && Linfocitos1TP>=10){
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("11500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("11500" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("11500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("11500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BHNeonato1a4días.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BHNeonato1a4días().setVisible(true);
            }
        });
    }
