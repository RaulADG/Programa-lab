 ...
 * @author raula
 */
public class CargaviralHCV extends javax.swing.JFrame {
 ...
 Calendar calendario;
    ...
    public CargaviralHCV() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from CargaviralHCV where ID_estudio = '" + IEstudio + "'");
          ...
          if (rs2.next()) {
            ...
            txt_Logaritmo.setText(rs2.getString("Logaritmo_HCV"));
            txt_CopiasmL.setText(rs2.getString("CopiasmL"));
          }
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into CargaviralHCV values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                   "update CargaviralHCV set Fecha_entrega=?, Hora=?, Observaciones=?, Logaritmo_HCV=?, CopiasmL=?,ultima_modificacion=? " 
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
           ...
           try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update CargaviralHCV set Hora=?, ultima_modificacion=?"
     ...
     com.itextpdf.text.Image logo = com.itextpdf.text.Image.getInstance("images/LogoT.jpg");
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        Chunk chunk2 = new Chunk("Carga viral para Hepatitis C", FontFactory.getFont("arial", 11,Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph metodo = new  Paragraph ("Método: PCR Tiempo real" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargaviralHCV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargaviralHCV().setVisible(true);
            }
        });
    }
