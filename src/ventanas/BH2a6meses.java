 ...
 * @author raula
 */
public class BH2a6meses extends javax.swing.JFrame {
    ...
    public BH2a6meses() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BH2a6meses where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BH2a6meses set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
         ...
         try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BH2a6meses set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      double EritrocitosRe, HemoglobinaRe, HematocritoRe, VolumenGlobularMedioVCMRe, ConcentracióMediadeHemoglobinaHCMRe,
        ...
        elevado6_1.setSpacingAfter(0);
          ...
          if(EritrocitosRe>4.3 && EritrocitosRe<5.1){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>4.3 && EritrocitosRe<5.1){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>=5.1 && EritrocitosRe<10){
        ...
        Paragraph Num411 = new  Paragraph ("5.1" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num412 = new  Paragraph ("5.1" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num413 = new  Paragraph ("5.1" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HemoglobinaRe>12 && HemoglobinaRe<16){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>12 && HemoglobinaRe<16){
        HemoglobinaR2.setIndentationLeft((float) 324);
        documento.add(HemoglobinaR2);
        } else {
        if(HemoglobinaRe>=13 && HemoglobinaRe<=15) {  
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>16 && HemoglobinaRe<100){
        HemoglobinaR3.setIndentationLeft((float) 324);
        documento.add(HemoglobinaR3);
        } else {
        if(HemoglobinaRe>=16 && HemoglobinaRe<=99) {  
        ...
        Paragraph Num4111 = new  Paragraph ("16" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4112 = new  Paragraph ("16" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num4113 = new  Paragraph ("16" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HematocritoRe>32 && HematocritoRe<41){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>10 && HematocritoRe<32){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>32 && HematocritoRe<41){
        HematocritoR2.setIndentationLeft((float) 324);
        documento.add(HematocritoR2);
        } else {
        if(HematocritoRe>=33 && HematocritoRe<=40) {  
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>41 && HematocritoRe<100){
        HematocritoR3.setIndentationLeft((float) 324);
        documento.add(HematocritoR3);
        } else {
        if(HematocritoRe>=41 && HematocritoRe<=99) {  
        ...
        Paragraph Num51111 = new  Paragraph ("32" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num51112 = new  Paragraph ("32" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num51113 = new  Paragraph ("32" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41111 = new  Paragraph ("41" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41112 = new  Paragraph ("41" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num41113 = new  Paragraph ("41" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Leucocitostotales1.setSpacingAfter(-3);
          ...
          if(LeucocitostotalesTT>6000 && LeucocitostotalesTT<16000){
        ...
        Leucocitostotales12.setSpacingAfter(-3);  
          ...
          if(LeucocitostotalesTT>=10 && LeucocitostotalesTT<=6000){
        ...
        Paragraph LeucocitostotalesV = new  Paragraph ("6000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV1 = new  Paragraph ("6000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV12 = new  Paragraph ("6000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV123 = new  Paragraph ("6000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2 = new  Paragraph ("16000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV21 = new  Paragraph ("16000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV212 = new  Paragraph ("16000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2123 = new  Paragraph ("16000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(Linfocitos1TT>4000 && Linfocitos1TT<10500){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<=4000){
        ...
        if(Linfocitos1TT>4000 && Linfocitos1TT<10500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<=4000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=10500 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>4000 && Linfocitos1TT<10500 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<=4000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>=10500 && Linfocitos1TP>=10){
        ...
        Paragraph Linfocitosref = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref1 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref2 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref3 = new  Paragraph ("4000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("10500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("10500" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("10500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("10500" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BH2a6meses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BH2a6meses().setVisible(true);
            }
        });
    }
