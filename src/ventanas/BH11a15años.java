 ...
 * @author raula
 */
public class BH11a15años extends javax.swing.JFrame {
    ...
    public BH11a15años() {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BH11a15años where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BH11a15años values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BH11a15años set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
    ...
    private void jButton_ImprimirReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ImprimirReporteActionPerformed
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
         ...
         try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BH11a15años set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      BaseFont baseFontL = BaseFont.createFont("fonts/monotype-corsiva.ttf", BaseFont.WINANSI, BaseFont.EMBEDDED);
        ...
        Paragraph Num511 = new  Paragraph ("4.7" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num512 = new  Paragraph ("4.7" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num513 = new  Paragraph ("4.7" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>12.8 && HemoglobinaRe<14){
        ...
        if(HemoglobinaRe>=14 && HemoglobinaRe<=99) {  
        ...
        Paragraph Num5111 = new  Paragraph ("12.8" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num5112 = new  Paragraph ("12.8" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num5113 = new  Paragraph ("12.8" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>34 && HematocritoRe<45){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>45 && HematocritoRe<100){
        ...
        Paragraph Num41111 = new  Paragraph ("45" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41112 = new  Paragraph ("45" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num41113 = new  Paragraph ("45" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMR1 = new  Paragraph (txt_VolumenGlobularMedioVCM.getText() , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        VCMR1.setSpacingBefore((float) -12.5);
        VCMR1.setSpacingAfter(-3);
        ...
        Paragraph VCMR2 = new  Paragraph (txt_VolumenGlobularMedioVCM.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph VCMR4 = new  Paragraph (txt_VolumenGlobularMedioVCM.getText() , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BH11a15años.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BH11a15años().setVisible(true);
            }
        });
    }
