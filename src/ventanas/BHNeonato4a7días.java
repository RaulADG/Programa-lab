 ...
 * @author raula
 */
public class BHNeonato4a7días extends javax.swing.JFrame {
...
String user = "", nom_paciente = "";
       ...
       try {
        ...
        try {
          ...
          PreparedStatement pst2 = cn2.prepareStatement(
                  "select * from BHNeonato4a7días where ID_estudio = '" + IEstudio + "'");
 ...
 @Override
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_ImprimirReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 700, 150, -1));
    ...
    private void jButton_GuardarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "insert into BHNeonato4a7días values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) ");
    ...
    private void jButton_ActualizarDatosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ActualizarDatosActionPerformed
      ...
      Reporte_generado1 = "Si";
       ...
       try {
             ...
             Connection cn = Conexion.conectar();
             PreparedStatement pst = cn.prepareStatement(
                     "update BHNeonato4a7días set Fecha_entrega=?, Hora=?, Observaciones=?, Eritrocitos=?, Hemoglobina=?, Hematocrito=?, VolumenGlobularMedioVCM=?, ConcentraciónMediadeHemoglobinaHCM=?, ConcentraciónMediadeHemoglobinaCorpuscularCHCM=?, ÍndicededistribucióndeeritrocitosRDW=?, Plaquetas=?, VolumenPlaquetarioMedioVPM=?, Leucocitostotales=?, Leucocitostotales1=?, Neutrófilostotales=?,Neutrófilostotales1=?, Neutrófilossegmentados=?, Neutrófilossegmentados1=?, Neutrófilosenbanda=?, Neutrófilosenbanda1=?,Metamielocitos=?, Metamielocitos1=?, Mielocitos=?, Mielocitos1=?, Promielocitos=?, Promielocitos1=?, Blastos=?, Blastos1=?, Eosinófilos=?, Eosinófilos1=?, Basófilos=?, Basófilos1=?, Monocitos=?, Monocitos1=?, Linfocitos=?, Linfocitos1=?, ultima_modificacion=?"
      ...
      horaA = hourtwenty2.format(d2) + " "+ ampm;
          ...
          try {
             ...
             PreparedStatement pstA = cnA.prepareStatement(
                     "update BHNeonato4a7días set Hora=?, ultima_modificacion=?"
     ...
     try {
      ...
      PdfContentByte canvas = writer.getDirectContent();
        ...
        elevado6_1.setSpacingAfter(0);
          ...
          if(EritrocitosRe>=3.1 && EritrocitosRe<=4.5){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>=0 && EritrocitosRe<3.1){
        copiasR0DD.setIndentationLeft((float) 326);
        documento.add(copiasR0DD);
        } else {
        if(EritrocitosRe>=0 && EritrocitosRe<=3) {  
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>3.1 && EritrocitosRe<=4.5){
        ...
        if(txt_Eritrocitos.getText().contains(".") && EritrocitosRe>4.5 && EritrocitosRe<10){
        copiasR2D.setIndentationLeft((float) 326);
        documento.add(copiasR2D);
        } else {
        if(EritrocitosRe>=5 && EritrocitosRe<=9) {  
        ...
        Paragraph Num511 = new  Paragraph ("3.1" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num512 = new  Paragraph ("3.1" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num513 = new  Paragraph ("3.1" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num411 = new  Paragraph ("4.5" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num412 = new  Paragraph ("4.5" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num413 = new  Paragraph ("4.5" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HemoglobinaRe>=14 && HemoglobinaRe<=22){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>10 && HemoglobinaRe<14){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>14 && HemoglobinaRe<22){
        ...
        if(txt_Hemoglobina.getText().contains(".") && HemoglobinaRe>22 && HemoglobinaRe<100){
        HemoglobinaR3.setIndentationLeft((float) 324);
        documento.add(HemoglobinaR3);
        } else {
        if(HemoglobinaRe>=23 && HemoglobinaRe<=99) {  
        ...
        Paragraph Num5111 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num5112 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num5113 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4111 = new  Paragraph ("22" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num4112 = new  Paragraph ("22" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num4113 = new  Paragraph ("22" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(HematocritoRe>=33 && HematocritoRe<=44){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>10 && HematocritoRe<33){
        HematocritoR1.setIndentationLeft((float) 324);
        documento.add(HematocritoR1);
        } else {
        if(HematocritoRe>=10 && HematocritoRe<=32) {  
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>33 && HematocritoRe<44){
        ...
        if(txt_Hematocrito.getText().contains(".") && HematocritoRe>44 && HematocritoRe<100){
        ...
        Paragraph Num51111 = new  Paragraph ("33" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num51112 = new  Paragraph ("33" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num51113 = new  Paragraph ("33" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41111 = new  Paragraph ("44" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Num41112 = new  Paragraph ("44" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Num41113 = new  Paragraph ("44" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(VolumenGlobularMedioVCMRe<88){
        documento.add(VCM);
        }
        ...
        if(VolumenGlobularMedioVCMRe>=88 && VolumenGlobularMedioVCMRe<=126){
        documento.add(VCM1);
        } 
        ...
        if(VolumenGlobularMedioVCMRe>126){
        documento.add(VCM2);
        } 
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>10 && VolumenGlobularMedioVCMRe<88){
        VCMR2.setIndentationLeft((float) 324);
        documento.add(VCMR2);
        } else {
        if(VolumenGlobularMedioVCMRe>=10 && VolumenGlobularMedioVCMRe<=87) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>88 && VolumenGlobularMedioVCMRe<100){
        VCMR3.setIndentationLeft((float) 324);
        documento.add(VCMR3);
        } else {
        if(VolumenGlobularMedioVCMRe>=88 && VolumenGlobularMedioVCMRe<=99) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>100 && VolumenGlobularMedioVCMRe<126){
        VCMR4.setIndentationLeft((float) 323);
        documento.add(VCMR4);
        } else {
        if(VolumenGlobularMedioVCMRe>=100 && VolumenGlobularMedioVCMRe<=126) {  
        ...
        if(txt_VolumenGlobularMedioVCM.getText().contains(".") && VolumenGlobularMedioVCMRe>126 && VolumenGlobularMedioVCMRe<1000){
        VCMR5.setIndentationLeft((float) 323);
        documento.add(VCMR5);
        } else {
        if(VolumenGlobularMedioVCMRe>=127 && VolumenGlobularMedioVCMRe<=999) {  
        ...
        Paragraph VCMref = new  Paragraph ("88" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref1 = new  Paragraph ("88" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph VCMref2 = new  Paragraph ("88" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref3 = new  Paragraph ("126" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph VCMref4 = new  Paragraph ("126" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph VCMref5 = new  Paragraph ("126" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(ConcentracióMediadeHemoglobinaHCMRe<28){
        documento.add(HCM);
        }
        ...
        if(ConcentracióMediadeHemoglobinaHCMRe>=28 && ConcentracióMediadeHemoglobinaHCMRe<=40){
        documento.add(HCM1);
        } 
        ...
        if(ConcentracióMediadeHemoglobinaHCMRe>40){
        documento.add(HCM2);
        } 
        ...
        if(txt_ConcentracióMediadeHemoglobinaHCM.getText().contains(".") && ConcentracióMediadeHemoglobinaHCMRe>10 && ConcentracióMediadeHemoglobinaHCMRe<28){
        ...
        if(txt_ConcentracióMediadeHemoglobinaHCM.getText().contains(".") && ConcentracióMediadeHemoglobinaHCMRe>28 && ConcentracióMediadeHemoglobinaHCMRe<40){
        ...
        if(txt_ConcentracióMediadeHemoglobinaHCM.getText().contains(".") && ConcentracióMediadeHemoglobinaHCMRe>40 && ConcentracióMediadeHemoglobinaHCMRe<100){
        HCMR4.setIndentationLeft((float) 324);
        documento.add(HCMR4);
        } else {
        if(ConcentracióMediadeHemoglobinaHCMRe>=41 && ConcentracióMediadeHemoglobinaHCMRe<=99) {  
        ...
        Paragraph HCMref = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph HCMref1 = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph HCMref2 = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph HCMref12 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph HCMref122 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph HCMref123 = new  Paragraph ("40" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<28){
        documento.add(CHCM);
        }
        ...
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>=28 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<=38){
        documento.add(CHCM1);
        } 
        ...
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>38){
        documento.add(CHCM2);
        } 
        ...
        if(txt_ConcentraciónMediadeHemoglobinaCorpuscularCHCM.getText().contains(".") && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>10 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<28){
        CHCMR1.setIndentationLeft((float) 324);
        documento.add(CHCMR1);
        } else {
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>=10 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<=27) {  
        ...
        if(txt_ConcentraciónMediadeHemoglobinaCorpuscularCHCM.getText().contains(".") && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>28 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<38){
        ...
        if(txt_ConcentraciónMediadeHemoglobinaCorpuscularCHCM.getText().contains(".") && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>38 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<100){
        CHCMR3.setIndentationLeft((float) 324);
        documento.add(CHCMR3);
        } else {
        if(ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe>=39 && ConcentraciónMediadeHemoglobinaCorpuscularCHCMRe<=99) {  
        ...
        Paragraph CHCMref = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph CHCMref1 = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph CHCMref2 = new  Paragraph ("28" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph CHCMref12 = new  Paragraph ("38" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph CHCMref13 = new  Paragraph ("38" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph CHCMref14 = new  Paragraph ("38" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        if(ÍndicededistribucióndeeritrocitosRDWRe<11.5){
        documento.add(RDW);
        }
        ...
        if(ÍndicededistribucióndeeritrocitosRDWRe>=11.5 && ÍndicededistribucióndeeritrocitosRDWRe<=14){
        documento.add(RDW1);
        } 
        ...
        if(ÍndicededistribucióndeeritrocitosRDWRe>14){
        documento.add(RDW2);
        } 
        ...
        Paragraph RDWR1 = new  Paragraph (txt_ÍndicededistribucióndeeritrocitosRDW.getText() , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        RDWR1.setSpacingBefore((float) -12.5);
        RDWR1.setSpacingAfter(-3);
               
        if(txt_ÍndicededistribucióndeeritrocitosRDW.getText().contains(".") && ÍndicededistribucióndeeritrocitosRDWRe>10 && ÍndicededistribucióndeeritrocitosRDWRe<11.5){
        RDWR1.setIndentationLeft((float) 324);
        documento.add(RDWR1);
        } else {
        if(ÍndicededistribucióndeeritrocitosRDWRe>=10 && ÍndicededistribucióndeeritrocitosRDWRe<=11) {  
        RDWR1.setIndentationLeft((float) 327);
        documento.add(RDWR1);
          }
        }
        
        Paragraph RDWR11 = new  Paragraph (txt_ÍndicededistribucióndeeritrocitosRDW.getText() , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        RDWR11.setSpacingBefore((float) -12.5);
        RDWR11.setSpacingAfter(-3);
               
        if(txt_ÍndicededistribucióndeeritrocitosRDW.getText().contains(".") && ÍndicededistribucióndeeritrocitosRDWRe>11.5 && ÍndicededistribucióndeeritrocitosRDWRe<14){
        RDWR11.setIndentationLeft((float) 324);
        documento.add(RDWR11);
        } else {
        if(ÍndicededistribucióndeeritrocitosRDWRe>=12 && ÍndicededistribucióndeeritrocitosRDWRe<=14) {  
        RDWR11.setIndentationLeft((float) 327);
        documento.add(RDWR11);
          }
        }
        ...
        if(txt_ÍndicededistribucióndeeritrocitosRDW.getText().contains(".") && ÍndicededistribucióndeeritrocitosRDWRe>14 && ÍndicededistribucióndeeritrocitosRDWRe<100){
        ...
        Paragraph RDWref = new  Paragraph ("11.5" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        RDWref.setSpacingBefore((float) -12);
        RDWref.setIndentationLeft((float) 443);
        ...
        Paragraph RDWref1 = new  Paragraph ("11.5" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        RDWref1.setSpacingBefore((float) -12);
        RDWref1.setIndentationLeft((float) 443);
        ...
        Paragraph RDWref2 = new  Paragraph ("11.5" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        RDWref2.setSpacingBefore((float) -12);
        RDWref2.setIndentationLeft((float) 443);
        ...
        Paragraph RDWref12 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph RDWref13 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph RDWref14 = new  Paragraph ("14" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Leucocitostotales1.setSpacingAfter(-3);
          ...
          if(LeucocitostotalesTT>=5000 && LeucocitostotalesTT<=21000){
        ...
        Leucocitostotales12.setSpacingAfter(-3);  
          ...
          if(LeucocitostotalesTT>=10 && LeucocitostotalesTT<5000){
        ...
        Paragraph LeucocitostotalesV = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV1 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV12 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV123 = new  Paragraph ("5000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2 = new  Paragraph ("21000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV21 = new  Paragraph ("21000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV212 = new  Paragraph ("21000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LeucocitostotalesV2123 = new  Paragraph ("21000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        NeutrófilosS1 .setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1000 && Neutrófilossegmentados1TT<=9000){
        ...
        NeutrófilosS3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>9000){
        ...
        NeutrófilosSR1.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1000 && Neutrófilossegmentados1TT<=9000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR3.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>9000 && Neutrófilossegmentados1TP<=9){
        ...
        NeutrófilosSR1P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>=1000 && Neutrófilossegmentados1TT<=9000 && Neutrófilossegmentados1TP>=10){
        ...
        NeutrófilosSR3P.setSpacingAfter(-3);
          ...
          if(Neutrófilossegmentados1TT>9000 && Neutrófilossegmentados1TP>=10){
        ...
        Paragraph NeutrófilosSref2 = new  Paragraph ("9000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref21 = new  Paragraph ("9000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref22 = new  Paragraph ("9000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph NeutrófilosSref23 = new  Paragraph ("9000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Eosinófilos1.setSpacingAfter(-3);
          ...
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700){
        ...
        Paragraph EosinófilosR = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph EosinófilosR1 = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        EosinófilosR1.setSpacingBefore((float) -12.5);
        EosinófilosR1.setIndentationLeft((float) 327);
        EosinófilosR1.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=10 && Eosinófilos1TT<=50 && Eosinófilos1TP<=9){
        
        documento.add(EosinófilosR1);
        } 

        Paragraph EosinófilosRA1 = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        EosinófilosRA1.setSpacingBefore((float) -12.5);
        EosinófilosRA1.setIndentationLeft((float) 327);
        EosinófilosRA1.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700 && Eosinófilos1TP<=9){
        
        documento.add(EosinófilosRA1);
        }
        ...
        Paragraph EosinófilosRP1 = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph EosinófilosRP2 = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        EosinófilosRP2.setSpacingBefore((float) -12.5);
        EosinófilosRP2.setIndentationLeft((float) 322);
        EosinófilosRP2.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=10 && Eosinófilos1TT<=50 && Eosinófilos1TP>=10){
        
        documento.add(EosinófilosRP2);
        } 

        Paragraph EosinófilosRPA2 = new  Paragraph (txt_Eosinófilos.getText() + "%", FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        EosinófilosRPA2.setSpacingBefore((float) -12.5);
        EosinófilosRPA2.setIndentationLeft((float) 322);
        EosinófilosRPA2.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700 && Eosinófilos1TP>=10){
        
        documento.add(EosinófilosRPA2);
        } 
        ...
        Paragraph EosinófilosV = new  Paragraph (txt_Eosinófilos1.getText() + " " + "/uL", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph EosinófilosV1 = new  Paragraph (txt_Eosinófilos1.getText() + " " + "/uL", FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        EosinófilosV1.setSpacingBefore((float) -12);
        EosinófilosV1.setIndentationLeft(380);
        EosinófilosV1.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=10 && Eosinófilos1TT<50){
        
        documento.add(EosinófilosV1);
        } 

        Paragraph EosinófilosV21 = new  Paragraph (txt_Eosinófilos1.getText() + " " + "/uL", FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        EosinófilosV21.setSpacingBefore((float) -12);
        EosinófilosV21.setIndentationLeft(380);
        EosinófilosV21.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700){
        
        documento.add(EosinófilosV21);
        } 
        ...
        Paragraph Eosinófilosref = new  Paragraph ("50" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        Eosinófilosref.setSpacingBefore((float) -12);
        Eosinófilosref.setIndentationLeft((float) 450.5);
        ...
        Paragraph Eosinófilosref1 = new  Paragraph ("50" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        Eosinófilosref1.setSpacingBefore((float) -12);
        Eosinófilosref1.setIndentationLeft((float) 450.5);
        ...
        Paragraph EosinófilosrefA1 = new  Paragraph ("50" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        EosinófilosrefA1.setSpacingBefore((float) -12);
        EosinófilosrefA1.setIndentationLeft((float) 450.5);
        EosinófilosrefA1.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700){
        
        documento.add(EosinófilosrefA1);
        } 
        
        Paragraph Eosinófilosref2 = new  Paragraph ("50" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        Eosinófilosref2.setSpacingBefore((float) -12);
        Eosinófilosref2.setIndentationLeft((float) 450.5);
        ...
        Paragraph EosinófilosrefP1 = new  Paragraph ("700" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph EosinófilosrefP2 = new  Paragraph ("700" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph EosinófilosrefPAA2 = new  Paragraph ("700" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        EosinófilosrefPAA2.setSpacingBefore((float) -12);
        EosinófilosrefPAA2.setIndentationLeft((float) 514);
        EosinófilosrefPAA2.setSpacingAfter(-3);
   
          if(Eosinófilos1TT>=50 && Eosinófilos1TT<=700){
        
        documento.add(EosinófilosrefPAA2);
        } 
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=17000){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<2000){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=17000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<2000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>17000 && Linfocitos1TP<=9){
        ...
        if(Linfocitos1TT>=2000 && Linfocitos1TT<=17000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>=10 && Linfocitos1TT<2000 && Linfocitos1TP>=10){
        ...
        if(Linfocitos1TT>17000 && Linfocitos1TP>=10){
        ...
        Paragraph Linfocitosref = new  Paragraph ("2000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref1 = new  Paragraph ("2000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref2 = new  Paragraph ("2000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph Linfocitosref3 = new  Paragraph ("2000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP2 = new  Paragraph ("17000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP3 = new  Paragraph ("17000" , FontFactory.getFont("arial", 10, Font.NORMAL, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP4 = new  Paragraph ("17000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
        ...
        Paragraph LinfocitosrefP5 = new  Paragraph ("17000" , FontFactory.getFont("arial", 10, Font.BOLD, BaseColor.BLACK));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BHNeonato4a7días.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BHNeonato4a7días().setVisible(true);
            }
        });
    }
